...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className="section relative border-t border-line px-6 md:px-20 py-20 md:py-40 bg-panel border-b border-line overflow-hidden"
    >
      <div
        aria-hidden="true"
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-14 relative z-[2]">
        <div data-reveal>
          ...
          <h2 className="text-[40px] md:text-[6vw] lg:text-[84px] uppercase mt-5">
            Have an idea?
          </h2>

          <h2 className="text-[40px] md:text-[6vw] lg:text-[84px] uppercase text-signal">
            Let's build it.
          </h2>

          <p className="text-text-dim mt-5 max-w-[44ch]">
            Tell us where you're headed. We'll tell you how to get there —
            with AI, software, and design that actually ships.
          </p>
        </div>
        ...
        >
          ...
          <button
            ...
            className="btn btn-primary magnetic self-start mt-2"
          >
            <span>
              {status === 'sending'
                ? 'Sending…'
...
function Field({
  ...
  return (
    <div className="flex flex-col gap-2">
      <label className="font-mono text-[11px] uppercase tracking-wide text-text-dim">
        {label}
      </label>
      ...
      <div
        className="
          ...
          [&>textarea]:border-0
          [&>textarea]:border-b
          [&>textarea]:border-line
          [&>textarea]:py-2.5
          [&>textarea]:focus:border-signal
